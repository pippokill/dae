...
> usage: Downloader - Download the whole history Wikipedia dump
 -d <arg>   Dump date (for example 20181101)
 -n <arg>   Number of download threads (default 3)
...
> usage: ProcessDump - Build CSV files for entities extracted from a Wikipedia dump
 -d <arg>     Input directory
 -exc <arg>   Load exclude file
 -l <arg>     Download log
...
usage: Aggregate data - Build final dataset by aggregating data from CSVs
 -d         Delete CSV file
 -i <arg>   Input dir
 -o <arg>   Output directory
 -w         Overwrite files
...
usage: Build final dataset
 -b <arg>   Batch size
 -d <arg>   Dictionary
 -i <arg>   Input dir
 -m <arg>   Min occurrences
 -o <arg>   Output file
